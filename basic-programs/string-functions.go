// Go Program with a lot of examples using string functions
...
func main() {
	...
	fmt.Println("-----------------------------------")
	fmt.Println("Repeat Function: ", strings.Repeat("Brazil", 3))
	...
	fmt.Println("-----------------------------------")
	fmt.Println("Split Function: ", strings.Split("Australia-Japan,German", "-"))

	fmt.Println("-----------------------------------")
	fmt.Println("ToLower Function", strings.ToLower("Brazil"))

	fmt.Println("-----------------------------------")
	fmt.Println("ToUpper Function", strings.ToUpper("Austrália"))
